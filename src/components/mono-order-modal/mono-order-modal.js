...
const MonoOrderModal = ({ id, closeOrderModal }) => {
    ...
    const { appStatus, serverStatus } = order;
        ...
        <Modal show={true}>
            ...
            <Modal.Body>
                <ul className="list-group">
                    ...
                    <li className="list-group-item d-flex justify-content-between">
                        PayGate ID
                        <span>{order.paymentGatewayId}</span>
                    </li>
                    <li className="list-group-item d-flex justify-content-between">
                        App ID
                    ...
                    <li className="list-group-item d-flex justify-content-between">
                        <span>Pay Gate <i className="far fa-clock"></i>&nbsp;
                            {order.payGateTime ? order.payGateTime.slice(12) : ''}
                        </span>
